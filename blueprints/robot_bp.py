...
@robot_bp.route('/robots/<robot_id>/heartbeat', methods=['POST'])
...
#region Robot Data Relay API
@robot_bp.route('/robot/emit/image', methods=['POST'])
...
@robot_bp.route('/robot/emit/text', methods=['POST'])
def robot_emit_text():
...
@robot_bp.route('/robot/stdout', methods=['POST'])
def robot_stdout():
...
@robot_bp.route('/robot/stderr', methods=['POST'])
def robot_stderr():
...
@robot_bp.route('/robot/finished', methods=['POST'])
def robot_finished():
    ...
    try:
        ...
        socketio = get_socketio()
        if socketio:
            socketio.emit('finished', {}, room=session_id)
